...
return [
    'seeders' => [
        ...
        'core' => [
            'channels' => [
                'name'             => 'Default',
                'meta-title'       => 'Hero store',
                'meta-keywords'    => 'Hero store meta keyword',
                'meta-description' => 'Hero store meta description',
            ],
        ...
        'shop' => [
            'theme-customizations' => [
                ...
                'offer-information' => [
                    'content' => [
                        'title' => 'သင်၏ ပထမဆုံး အော်ဒါတွင် ၄၀% အထိ လျှော့ဈေး ရယူပါ SHOP NOW',
                    ],
