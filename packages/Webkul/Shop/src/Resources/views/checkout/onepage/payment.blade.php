        ...
        app.component('v-payment-methods', {
            ...
            methods: {
                store(selectedMethod) {
                    ...
                    // this.isMyanmarPay = selectedMethod.method_title == 'MyanmarPay';

                    // if (this.isMyanmarPay) {
                    //     this.myanmarpayPayment = {
                    //         is_myanmarpay: true,
                    //         name: 'Customer Name',
                    //         transcation_code: '22557180903',
                    //         phone: '092400113',
                    //         myanmar_wallet_payment_method_type_name: 'AYA Pay',
                    //     };

                    //     console.log({...selectedMethod, ...this.myanmarpayPayment});

                    //     this.selectedPaymentMethod = {...selectedMethod,...this.myanmarpayPayment};
                    // } else {
                    ...
                    this.$axios.post("{{ route('shop.checkout.onepage.payment_methods.store') }}", {
                        ...
                        .then(response => {
                            this.$emit('processed', {cart: response.data.cart, myanmarpay: response.data.myanmarpay});
